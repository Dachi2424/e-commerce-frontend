      ...
      <div className="products-page__layout">
        ...
        <div className="products-page__main">
          <div className="products-page__navigation">
            ...
            <ChevronRight size={13} className="products-page__chevron" />
            <span>{category ? `${category}s` : "All products"}</span>
          </div>
          <div className="products-page__category-name-container">
            <h2 className="products-page__category-name">{category ? category + "s" : "All products"}</h2>
